...
from .mapper import Mapper, TrieMapper, MarkovTrieMapper
...
class CustomMarkovTrieMapper:
    ...
    def new(cls, path, resource_package=RESOURCE_PACKAGE):
        ...
        """
        return functools.partial(
            MarkovTrieMapper.load, resource_package=resource_package, resource_path=path
        )
...
load_markov_en = CustomMarkovTrieMapper.new("markov_en.json.gz")
